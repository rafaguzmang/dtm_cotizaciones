...
class Indicadores(models.Model):
    ...
    uno_pasadas = fields.Integer(string="Pasadas1")
    ...
    odt_uno = fields.Integer(string="Total 2")
    odt_con_uno = fields.Integer(string="Con Orden de Compra1")
    odt_sin_uno = fields.Integer(string="Sin Orden de Compra1")

    dos_days = fields.Integer(string="Total3")
    dos_sin = fields.Integer(string="Sin cotizaciòn2")
    dos_pasadas = fields.Integer(string="Pasadas2")
    dos_fecha_caducada = fields.Integer(string="Mayor a 5 dias")
    dos_percent = fields.Float(string="%2")
    dos_con = fields.Integer(string="Con cotización2")
    odt_dos = fields.Integer(string="Total4")
    odt_con_dos = fields.Integer(string="Con Orden de Compra2")
    odt_sin_dos = fields.Integer(string="Sin Orden de Compra2")

    tres_days = fields.Integer(string="Total5")
    tres_sin = fields.Integer(string="Sin cotizaciòn3")
    tres_pasadas = fields.Integer(string="Pasadas3")
    tres_fecha_caducada = fields.Integer(string="Mayor a 12 dias")
    tres_percent = fields.Float(string="%3")
    tres_con = fields.Integer(string="Con cotización3")
    odt_tres = fields.Integer(string="Total6")
    odt_con_tres = fields.Integer(string="Con Orden de Compra3")
    odt_sin_tres = fields.Integer(string="Sin Orden de Compra3")

    total = fields.Integer(string="Total7")
    sin_cotizacion = fields.Float(string="Sin Cotización4")
    pasadas = fields.Float(string="Pasadas4")
    odt = fields.Integer(string="Ordenes de compra4")
